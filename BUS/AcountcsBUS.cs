...
namespace BUS
{
    public class AcountcsBUS
    {
        ...
        {
            return TaiKhoanDao.Instance.SHA256(s);
        }
      ...
      public void loadtheocombox(string loai,GridControl data)
        ...
        public bool kiemtrataikhoanguoidung(string  usename)
        {
            return TaiKhoanDao.Instance.kiemtratrungusername(usename);
        }
        public bool kiemtramatkhau(string password)
        {
            return TaiKhoanDao.Instance.kiemtramatkhau(password);
        }
