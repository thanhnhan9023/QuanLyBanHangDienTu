 ...
 public   class ChiTietHDXuatBUS
    {
      ...
      public bool kiemtradulieuphieuxuat()
        ...
        public int laysoluongkho(string mahh)
        {
            return ChiTietHDXuatDao.Instance.laydusoluongkho(mahh);
        }
        public int laysoluonghangxuat(string mahdx)
        {
            return ChiTietHDXuatDao.Instance.laydusoluongdangxuat(mahdx);
        }
