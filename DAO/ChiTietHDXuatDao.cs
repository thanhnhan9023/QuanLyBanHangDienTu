  ...
  public  class ChiTietHDXuatDao
    {
        ...
        {
            string sql = "select  IDXuat,TenHH,DonViTinh,SoLuong_Xuat,DonGia_Xuat,ThanhTienXuat   from Kho,ChiTietHD_Xuat,HangHoa,HoaDon_Xuat   where HoaDon_Xuat.MAHD_Xuat=ChiTietHD_Xuat.MAHD_Xuat and HangHoa.MaHH=Kho.MAHH and Kho.IDKho=ChiTietHD_Xuat.IDKho and ChiTietHD_Xuat.MAHD_Xuat='"+mahdxuat+"'";
        ...
        {
            string sql = "select IDKho from Kho,HangHoa where HangHoa.MaHH=Kho.MAHH and Kho.MaHH='"+ma+"'";
            return Dataprovider.Instance.laydulieusql(sql);
        }

        public bool them1chietiethoadonxuat(ChiTietXuatHD chitethd)
        {
            string sql = "insert into ChiTietHD_Xuat values('"+chitethd.ID_HDXuat1+"','"+chitethd.ID_Kho1+"','"+chitethd.Mahdxuat+"',"+chitethd.Soluongxuat+","+chitethd.Dongiaxuat+","+chitethd.ThanhTien1+")";
            return Dataprovider.Instance.thucthicaulenhsql(sql);
        }
        public bool sua1chietiethoadonxuat(ChiTietXuatHD chitethd)
        {
            string sql = "update ChiTietHD_Xuat set IDKho='"+chitethd.ID_Kho1+"',MAHD_Xuat='"+chitethd.Mahdxuat+"',SoLuong_Xuat='"+chitethd.Soluongxuat+"',DonGia_Xuat='"+chitethd.Dongiaxuat+"' where IDXuat='"+chitethd.ID_HDXuat1+"'";
            return Dataprovider.Instance.thucthicaulenhsql(sql);
        }
